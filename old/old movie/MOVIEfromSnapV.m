function MOVIEfromSnapV(str_input,apstr,tem_at)
close all;
...
if exist([str,'movieV2_01',apstr,'.avi'],'file')
    delete([str,'movieV2_01',apstr,'.avi']);
end
...
vidObj = VideoWriter([str,'movieV2_01',apstr,'.avi']);
vidObj.FrameRate=25;
% vidObj.Quality=100;
open(vidObj);
...
for i=1:tem_at-1
    % h=figure(1);
    i
    h=openfig([str,'SnapshotV2/',num2str(i),'.fig'],'new','invisible');
